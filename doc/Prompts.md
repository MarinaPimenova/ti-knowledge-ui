...
1. User Opens http://localhost:5000/dashboard-page (I configure vite.config.ts like: base: '/dashboard-page',  // Set the base URL for the app) and "Landing-page concept for not logged-in users" is displayed.
